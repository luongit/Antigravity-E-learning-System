#!/usr/bin/env python3
"""
engines/cesium/export_slides.py
Bộ xuất bản bài giảng PowerPoint (.pptx) và tài liệu PDF 16:9 từ Cesium & 3D Globe Engine.
- Chụp ảnh snapshot Quả địa cầu 3D với dữ liệu độ cao, tọa độ địa lý và địa danh.
...
def export_cesium_slides(
    ...
    print("============================================================")
    print("🌍 [Cesium Slide Exporter] Xuất PowerPoint & PDF 16:9")
    print(f"   Thư mục học liệu: {video_dir}")
    print("============================================================")

    engine = CesiumEngine(video_dir)
    results = engine.export_slides(scenes_meta, output_dir, format_type, base_name)
    return results


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Xuất PowerPoint và PDF 16:9 từ Cesium Engine")
    ...
    parser.add_argument("--name", default="slides_cesium")
    ...
    print("Cesium Slide Exporter sẵn sàng nhận metadata scenes.")
